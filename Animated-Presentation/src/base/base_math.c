...
vec2_t vec2_mul( vec2_t a, f32  b   ) { return (vec2_t) { a.x * b, a.y * b };     }
vec2_t vec2_div( vec2_t a, f32  b   ) { return (vec2_t) { a.x / b, a.y / b };     }
f32    vec2_dot( vec2_t a, vec2_t b ) { return a.x * b.x + a.y * b.y;             }
f32    vec2_sql( vec2_t           v ) { return v.x * v.x + v.y * v.y;             }
f32    vec2_len( vec2_t           v ) { return sqrtf(v.x * v.x + v.y * v.y);      }
...
vec3_t vec3_mul( vec3_t a, f32  b   ) { return (vec3_t) { a.x * b, a.y * b, a.z * b };       }
vec3_t vec3_div( vec3_t a, f32  b   ) { return (vec3_t) { a.x / b, a.y / b, a.z / b };       }
f32    vec3_dot( vec3_t a, vec3_t b ) { return a.x * b.x + a.y * b.y + a.z * b.z;            }
f32    vec3_sql( vec3_t           v ) { return v.x * v.x + v.y * v.y + v.z + v.z;            }
f32    vec3_len( vec3_t           v ) { return sqrtf(v.x * v.x + v.y * v.y + v.z + v.z);     }
...
vec4_t vec4_mul( vec4_t a, f32  b   ) { return (vec4_t) { a.x * b, a.y * b, a.z * b, a.w * b };         }
vec4_t vec4_div( vec4_t a, f32  b   ) { return (vec4_t) { a.x / b, a.y / b, a.z / b, a.w / b };         }
f32    vec4_dot( vec4_t a, vec4_t b ) { return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w;           }
f32    vec4_sql( vec4_t           v ) { return v.x * v.x + v.y * v.y + v.z * v.z + v.w * v.w;           }
f32    vec4_len( vec4_t           v ) { return sqrtf(v.x * v.x + v.y * v.y + v.z * v.z + v.w * v.w);    }
